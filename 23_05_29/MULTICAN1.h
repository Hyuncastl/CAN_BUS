...
#include "IfxMultican.h"                                        //CAN 관련 함수
#include "IfxPort.h"                                            //Port 관련 함수 /* For GPIO Port Pin Control                        */
...
#define WAIT_TIME_40ms              40                          //WAIT_TIME_40ms 정의
...
/*-----------------------------------------------Function Prototypes-------------------------------------------------*/
/*********************************************************************************************************************/
void canIsrTxHandler(void);                             //TX인터럽트
void canIsrRxHandler(void);                             //RX인터럽트
void initMultican(void);                                //CAN통신 설정
void transmitCanMessage(void);                          //send message
void initLed(void);                                     //LED 핀 설정
